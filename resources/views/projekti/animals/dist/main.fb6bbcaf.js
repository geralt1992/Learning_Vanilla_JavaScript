...
function showAlert(message, className) {
  ...
  var form = document.querySelector('#pet-form'); //insert alert - sto insertamo , gdje insertamo
...
function fetchAnimals(e) {
  ...
  (0, _fetchJsonp.default)("http://api.petfinder.com/pet.find?format=json&key=bouWFA3DoKM4Q8ByGgSmWiS4NRAZ2491vvQ0r657QetAZBXD9h&animal=".concat(animal, "&location=").concat(zip, "&callback=callback"), {
...
function showAnimals(pets) {
  var results = document.querySelector('#results'); //clear previus results - $t je zbg njihovog apia

  results.innerHTML = '';
  pets.forEach(function (pet) {
    var div = document.createElement('div');
    div.classList.add('card', 'card-body', 'mb-3');
    div.innerHTML = "\n\n        <div class=\"row\">\n            <div class=\"col-sm-6\">\n                <h4>".concat(pet.name.$t, " (").concat(pet.age.$t, ")</h4>\n                <p class=\"text-secondary\">").concat(pet.breeds.breed.$t, "</p>\n                <p>").concat(pet.contact.adress1.$t, " ").concat(pet.contact.city.$t, " ").concat(pet.contact.state.$t, " ").concat(pet.contact.zip.$t, "/p>\n                <ul class=\"list-group\">\n                    <li class=\"list-group-item\">Phone: ").concat(pet.contact.phone.$t, "</li>\n                    ").concat(pet.contact.email.$t ? "<li class=\"list-group-item\">Email: ".concat(pet.contact.email.$t, "</li>") : "", "\n                    <li class=\"list-group-item\">Shalter ID: ").concat(pet.shalterId.$t, "</li>\n                </ul>\n            </div>\n\n\n            <div class=\"col-sm-6 text-center\">\n                <img class=\"img-fluid rounderd-circle mt-2\"src=").concat(pet.media.photos.photo[3].$t, "/>\n            </div>\n        </div>\n        ");
    results.appendChild(div);
  });
}
},{"fetch-jsonp":"node_modules/fetch-jsonp/build/fetch-jsonp.js","./validate.js":"js/validate.js"}],"../../../../../../../Users/Marin/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../../../../Users/Marin/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/main.js"], null)
